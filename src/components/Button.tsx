...
export function Button({
  ...
  const base = cn(
    ...
    variant === 'primary' && 'bg-accent text-white shadow-lg shadow-accent/20 hover:translate-y-[-1px] hover:bg-accent/90 hover:shadow-xl hover:shadow-accent/25',
    variant === 'ghost' && 'border border-outline/70 bg-[#eaf1ff]/85 text-slate-800 hover:border-accent hover:text-slate-900 dark:border-outline dark:bg-white/5 dark:text-slate-100 dark:hover:border-accent',
